...
Compared to the generic Card Selection API (cf. https://jeanpierrefortune.github.io/keyple-website/learn/architecture/keyple-core/#card-selection), a PO Selector could be defined to accept only non-invalidated Portable Object (in this cas an invalidated PO isn't selected).
